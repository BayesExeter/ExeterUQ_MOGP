...
Here we try to demonstrate implementation of mogp for emulating multiple outputs with subjective priors and complex mean functions. This repository acts as a front end for mogp, which is available here: https://github.com/alan-turing-institute/mogp_emulator
